...
###################################
@pytest.fixture(scope="class")
def create_leaf_stack_container_manager(cdk_app):
    def _create_container_manager_stack(base_stack, domain_stack, config) -> tuple[Template, ContainerManagerStack]:
        ...
        container_manager_template = Template.from_stack(container_manager_stack)
        return container_manager_template, container_manager_stack
