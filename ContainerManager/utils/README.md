...
- [maturity.py](./maturity.py) is for verifying that the maturity strings in the config are valid (case-sensitive). Moved to it's own file to fix [this bug](https://github.com/Cameronsplaze/AWS-ContainerManager/pull/180)
