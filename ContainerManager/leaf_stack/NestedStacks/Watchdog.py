...
class Watchdog(NestedStack):
    def __init__(
        ...
        **kwargs,
        ...
        evaluation_periods = int(minutes_without_players / self.metric_num_connections.period.to_minutes())
        self.alarm_num_connections = self.metric_num_connections.create_alarm(
            self,
            "Alarm-NumConnections",
            alarm_name=f"{leaf_construct_id}-Alarm-NumConnections",
        ...
        self.rule_watchdog_trigger = events.Rule(
            ...
            targets=[
                ...
                events_targets.LambdaFunction(self.lambda_watchdog_num_connections),
            ],
